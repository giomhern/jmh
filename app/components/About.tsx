    ...
    <main className="bg-white px-14 mx-auto">
      ...
      <div className="grid grid-cols-3 py-16">
        ...
        <div className="col-span-2">
          <h3 className="font-semibold text-3xl pb-3">About Me</h3>
          ...
          <h3 className="font-semibold text-3xl pb-3">My Business Journey</h3>
          <div className="md:text-lg text-sm">
            <p>
              I have also participated in numerous startup accelerator programs
              including:
            </p>
            <ul className="text-black list-disc px-10 pb-5">
